        ...
        <div className="container">
          <div className={styles.grid}>
            <div className={styles.brand}>
              <span className={styles.wordmark}>Masthead</span>
              <p className={styles.tagline}>Policy research and ideas at the intersection of technology and governance.</p>
            </div>
            <div className={styles.col}>
              <span className={styles.colLabel}>About</span>
              <Link href="/" className={styles.colLink}>Mission</Link>
